    ...
    return (
        <>
            <div className="w-full " style={{ height: "100%", fontFamily: 'Pretendard-Regular' }}>
                <div className="w-2/4 h-fit mx-auto my-20">
{/* 
                    ...
                    <div className="flex h-20 justify-around items-center rounded-2xl shadow-lg my-4" style={{ backgroundColor: "#f6f5efb3", border: "1px solid #d5d5d5" }}>
                        ...
                        <input className="w-96 h-10" style={{ border: "1px solid #d5d5d5",textAlign:"center" }} disabled type="text" id="number" value={myData.user_phone}></input>
                    </div>
                    <div className="flex h-20 justify-around items-center rounded-2xl shadow-lg my-4"style={{backgroundColor:"#f6f5efb3", border:"1px solid #d5d5d5"}}>
                        <div><button className="text-2xl  text-lime-700" style={{fontFamily: 'SUITE-Regular'}}>수정</button></div>
                        <div><button className="text-2xl  text-lime-700" style={{fontFamily: 'SUITE-Regular'}}>뒤로가기</button></div>
                    </div>
                </div>
            </div>
        </>
