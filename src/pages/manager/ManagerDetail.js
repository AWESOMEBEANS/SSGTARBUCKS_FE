...
export default function ManagerDetail() {
    ...
    return (
        <>
            ...
            {showModifyRenderer && <ModifyRenderer modifyList={modifyList} onUpdateDetails={handleUpdateDetails} initialUserId={initialUserId} onCancel={() => setShowModifyRenderer(false)} />}
        </>
    )
}
